...
| 01 | **LLMLingua PoC** — test prompt-compression library (pip / LangChain), run on a HuggingFace dataset against the Gemini API | **active** | [phase-01-llmlingua-poc.md](phase-01-llmlingua-poc.md) | [2026-09-21-dataset-switch-zero-scrolls](../worklog/2026-09-21-dataset-switch-zero-scrolls.md) |
